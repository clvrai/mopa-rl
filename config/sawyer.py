...
def add_arguments(parser):
    ...
    parser.add_argument(
        "--action_repeat", type=int, default=5, help="number of action repeats"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--range", type=float, default=0.1, help="range of motion planner"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--timelimit", type=float, default=1.0, help="timelimit for motion planner"
    )
    parser.add_argument(
        "--simple_planner_timelimit",
        type=float,
        default=0.05,
        help="timelimit for simple motion planner",
    )
    parser.add_argument(
        "--contact_threshold",
        type=float,
