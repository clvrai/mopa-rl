...
def argparser():
    ...
    # training algorithm
    parser.add_argument(
        "--algo", type=str, default="sac", choices=["sac", "td3"], help="RL algorithm"
    )
    parser.add_argument(
        "--policy", type=str, default="mlp", choices=["mlp"], help="policy type"
    )
    ...
    # training
    parser.add_argument(
        "--is_train", type=str2bool, default=True, help="enable training"
    )
    parser.add_argument(
        "--num_batches",
        type=int,
    ...
    parser.add_argument(
        "--evaluate_interval", type=int, default=10000, help="interval for evaluation"
    )
    parser.add_argument(
        "--ckpt_interval",
        type=int,
