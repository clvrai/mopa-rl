...
def add_arguments(parser):
    ...
    """
    # reacher
    parser.add_argument("--planner_type", type=str, default="rrt_connect",
                        choices=["sst", "rrt", "rrt_connect", "prm_star", "kpiece", "spars", "lazy_prm_star", "rrt_sharp"])
    parser.add_argument("--simple_planner_type", type=str, default="rrt_connect",
                        choices=["sst", "rrt", "rrt_connect", "prm_star", "kpiece", "spars", "lazy_prm_star"])
    parser.add_argument("--planner_objective", type=str, default="path_length",
