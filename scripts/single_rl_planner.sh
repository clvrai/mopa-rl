...
workers="1"
tanh="True"
prefix="05.19.SAC.REUSE.SUBGOAL.PUSHER.APPROXIMATE.SST.rew.1.5"
...
log_root_dir="./logs"
group='05.19.SAC.PLANNER.REUSE.SUBGOAL.PUSHER.APPROXIMATE.SST.rew.1.5'
env_debug='False'
log_freq='1000'
