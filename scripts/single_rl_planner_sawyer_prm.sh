...
workers="1"
tanh="True"
prefix="05.31.SAC.SAWYAER.REACH.EXACT.NO-REUSE.rrt_connect.timelimit.1.0.simple.0.01"
...
log_root_dir="./logs"
group='05.31.SAC.PLANNER.SAWYER.LIFT.EXACT.no_reuse.rrt_connect.timelimit.1.0.simple.0.01'
env_debug='False'
log_freq='1000'
