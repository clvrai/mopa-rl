...
class SawyerPushObstacleEnv(SawyerEnv):
    ...
    def static_geoms(self):
        return ['table_collision', 'obstacle0_geom','obstacle1_geom',
                'obstacle2_geom','obstacle3_geom','obstacle4_geom', 'obstacle5_geom', 'obstacle6_geom', 'obstacle7_geom']
    ...
    def _step(self, action, is_planner=False):
        ...
        if is_planner:
            ...
            rescaled_ac = np.clip(rescaled_ac, -self._ac_scale, self._ac_scale)
        else:
