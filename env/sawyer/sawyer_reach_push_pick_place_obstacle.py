...
from util.sawyer_env import get_stat_in_paths, \
...
class SawyerReachPushPickPlaceObstacleEnv(SawyerXYZEnv):
    def __init__(
            self,
            random_init=False,
    ...
    @property
    def model_name(self):
        return get_asset_full_path('sawyer_xyz/sawyer_reach_push_pick_and_place_obstacle.xml')
