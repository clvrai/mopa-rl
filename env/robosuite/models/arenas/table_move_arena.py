import numpy as np
from env.robosuite.models.arenas import Arena
from env.robosuite.utils.mjcf_utils import xml_path_completion
from env.robosuite.utils.mjcf_utils import array_to_string, string_to_array


class TableMoveArena(Arena):
    ...
    def __init__(
        ...
        """
        super().__init__(xml_path_completion("arenas/table_move_arena.xml"))

        self.table_full_size = np.array(table_full_size)
        self.table_half_size = self.table_full_size / 2
        self.table_quater_size = self.table_full_size // 4
        self.bin_size = self.table_full_size // 6
