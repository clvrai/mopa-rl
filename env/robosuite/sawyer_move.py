...
from env.robosuite.utils.mjcf_utils import string_to_array, new_joint
...
from env.robosuite.models.tasks import UniformRandomSampler, PickPlaceTask

class SawyerMoveEnv(SawyerEnv):
    def __init__(
        self, **kwargs):
        """
        Args:
    ...
    def _reset_internal(self):
        ...
        self.sim.data.qpos[np.arange(len(self.sim.data.qpos))] = [-7.03196863e-01, -3.14385192e-01,-1.05111322, 4.32474123e-01,
  1.63748623, -2.42865546e-01,  1.04502954,  1.54567766,
  2.92548543e-03, -2.59364232e-03,  9.99999634, -1.48084345e-01,
  7.60990655e-01, -7.39197237e-01, -3.39658275e-06, -3.16775936e-06,
  6.73489008e-01,  9.99711237, -2.16149631e-01,  7.23223052e-01,
 -5.54362528e-02, -1.21254120e-05,  1.11623275e-05,  9.98462228e-01,
  1.00705229e+01, -2.03436623e-01,  7.14967042e-01,  4.40195666e-01,
  4.40205809e-01,  5.53374474e-01,  5.53374478e-01,  6.46079718e-01,
 -1.23114576e-01,  1.10250946e+00,  9.97708599e-01,  5.22774941e-04,
 -1.11162726e-02,  6.67360902e-02,]
...
class SawyerMoveSingleEnv(SawyerMoveEnv):
    """
...
class SawyerMoveMilkEnv(SawyerMoveEnv):
    """
...
class SawyerMoveBreadEnv(SawyerMoveEnv):
    """
...
class SawyerMoveCerealEnv(SawyerMoveEnv):
    """
...
class SawyerMoveCanEnv(SawyerMoveEnv):
    """
