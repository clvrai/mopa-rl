...
from env.robosuite.models.arenas.obstacle_arena import ObstacleArena
from env.robosuite.models.objects import BoxObject
from env.robosuite.models.robots import Sawyer
from env.robosuite.models.tasks import TableTopTask, UniformRandomSampler
...
class SawyerPushEnv(SawyerEnv):
    ...
    def __init__(
        ...
        if kwargs['placement_initializer']:
            self.placement_initializer = kwargs['placement_initializer']
        else:
    ...
    def _load_model(self):
        ...
        self.mujoco_arena = ObstacleArena(
        ...
        self.mujoco_objects = OrderedDict([("cubeA", cubeA)])
