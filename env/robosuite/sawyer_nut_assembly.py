...
from env.robosuite.models.arenas import PegsArena
from env.robosuite.models.objects import SquareNutObject, RoundNutObject
from env.robosuite.models.robots import Sawyer
from env.robosuite.models.tasks import NutAssemblyTask, UniformRandomPegsSampler


class SawyerNutAssemblyEnv(SawyerEnv):
    """
...
class SawyerNutAssemblySingleEnv(SawyerNutAssemblyEnv):
    """
...
class SawyerNutAssemblySquareEnv(SawyerNutAssemblyEnv):
    """
...
class SawyerNutAssemblyRoundEnv(SawyerNutAssemblyEnv):
    """
